...
export function assertionsFromJSON(json, context) {
  ...
  const { TypeAssertion, SchemaAssertion, DefinedAssertion, PropertyAssertion, SubproofAssertion, ContainedAssertion, SignatureAssertion } = elements,
...
export function substitutionFromSubstitutionJSON(json, context) {
  const { TermSubstitution, StatementSubstitution } = elements,
        substitution = TermSubstitution.fromJSON(json, context) || StatementSubstitution.fromJSON(json, context);
