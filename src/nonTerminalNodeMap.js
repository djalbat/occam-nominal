...
import AxiomNode from "./node/claim/axiom";
import LemmaNode from "./node/claim/lemma";
...
import PremiseNode from "./node/fact/premise";
import TheoremNode from "./node/claim/theorem";
...
import ConclusionNode from "./node/resolution/conclusion";
...
const NonTerminalNodeMap = {
  ...
  [SCHEMA_ASSERTION_RULE_NAME]: SchemaAssertionNode,
