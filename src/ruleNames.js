...
export const SCHEMA_RULE_NAME = "schema";
...
export const TYPE_ALIAS_RULE_NAME = "typeAlias";
...
export const CONSTRAINT_RULE_NAME = "constraint";
export const SCHEMA_BODY_RULE_NAME = "schemaBody";
...
export const SCHEMA_HEADER_RULE_NAME = "schemaHeader";
...
export const GENERATOR_DECLARATION_RULE_NAME = "generatorDeclaration";
...
export const TYPE_ALIAS_DECLARATION_RULE_NAME = "typeAliasDeclaration";
